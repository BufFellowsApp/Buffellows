...
class ChallengeVC: StandardVC {
    ...
    var muscleGroupDict = [String : [String]]()
...
//                           "Legs" : ["Legs 1", "Legs 2"]]
    ...
    override func viewDidLoad() {
        ...
        muscleGroupDict = UserDefaults.standard.value(forKey: "exerciseData") as! [String : [String]]
        print(muscleGroupDict)
    ...
    func conditionChecking(_ string: String) {
        ...
        if(string == "Cardio") {
            setUpSearch(numRepsSearch, distDict, "Enter the Quantity!")
        } else {
            setUpSearch(numRepsSearch, numRepsDict, "Enter the Quantity!")
        }
    }
